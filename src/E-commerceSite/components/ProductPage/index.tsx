...
type ProductsProps = {
    ...
    SignOutProductPage : any
    doNetWorkCallForProducts : Function
...
class Products extends React.Component <ProductsProps>{
    render(){
        const {isUserSignOut, isUserLoggedOut, getProductsStore, SignOutProductPage,
                doNetWorkCallForProducts, renderSuccessUI} = this.props
        ...
        if(getAccessToken() === undefined)
            return isUserLoggedOut()
        const {getProductsListAPIStatus, getProductsListAPIError, searchedItems} = getProductsStore()
        return (
            <div className = "relative">
                <ProductPageHeader>
                    <div><SignOutButton onClick = {SignOutProductPage}>Sign Out</SignOutButton></div>
                    <SearchBy searchedItems={searchedItems}/>
                ...
                <div>
                    <LoadingWrapperWithFailure 
                        ...
                        onRetryClick = {doNetWorkCallForProducts}
...
//         if(getAccessToken() === undefined)
//             return this.isUserLoggedOut()
//         const {getProductsListAPIStatus, getProductsListAPIError, searchedItems} = this.getProductsStore()
//         return (
//             <div className = "relative">
//                 <ProductPageHeader>
